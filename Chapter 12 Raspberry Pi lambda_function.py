...
createMQTTClient = AWSIoTMQTTClient("MyThing2")
"""
Change this endpoint to suit yours
"""
createMQTTClient.configureEndpoint('a3egqx446fyf27-ats.iot.us-east-1.amazonaws.com', 443)
#createMQTTClient.configureEndpoint(os.environ['AWS_IOT_ENDPOINT'], 443)
"""
# Check these certificate names if necessary
"""
createMQTTClient.configureCredentials("./certs/AmazonRootCA1.pem", "./certs/MyThing-private.pem.key", "./certs/MyThing-certificate.pem.key")
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Hello, you can control the robot by saying move left, right, forwards or backwards. To stop it moving, say stop moving"
...
class StopMovingIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("StopMovingIntent")(handler_input)
...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output= "Hello, you can control the robot by saying move left or move right. To stop it moving, say stop moving"

        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask("Say turn left or turn right go forwards or go backwards or stop moving")
                .response
        )
...
class MoveDirectionIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        elif slots["direction"].value == 'back' or slots["direction"] == 'backward' or slots["direction"] == 'backwards':
        ...
        return (
            handler_input.response_builder
                .speak(speak_output)
                .ask("Moving - you can tell me to turn left or right or stop moving")
                .response
        )
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "tell me to move left or right or stop moving"
