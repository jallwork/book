# Change lines 89 and 163 to your product_id = "amzn1.adg…."
...
class TellMeMoreHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = 'You can buy an upgrade to hear more jokes. Just say "Buy jokes" to purchase them.'
...
class BuyHandler(AbstractRequestHandler):
    ...
    User says: Alexa, purchase/buy <category>.
    """
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
    ...
    def handle(self, handler_input):
        ...
        product_id = "amzn1.adg.product.b6c09ad1-da89-4c54-a924-7f10d5effb37"
...
class BuyResponseHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if handler_input.request_envelope.request.status.code == "200":     # 200 is OK
            speech = None
            reprompt = None
...
class RefundPurchaseHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        product_id= 'amzn1.adg.product.b6c09ad1-da89-4c54-a924-7f10d537'
        ...
        if isinstance(in_skill_response, InSkillProductsResponse):
            ...
            if entitled_prods:
                ...
                speak_output = (
                    ...
                    "for purchase, say 'What can I buy'"
                ).format(skill_name)
            reprompt = "Sorry, please try again, say 'Tell me a joke'"
        else:
